...
function initSelect(arr) {
    ...
    for (const element of arr) {
        createoption(select, element.who1, element.who1);
        if(element.who2){
            createoption(select, element.who2, element.who2);
        }
    }
}
...
function createNewElement(obj, form, array) {
    createoption(getSelectElement(), obj.who1, obj.who1);
    if(obj.who2){
        createoption(getSelectElement(), obj.who2, obj.who2)
    }
